...
#ifndef UNBOWED_FLUTTER_SWIFT_H
#define UNBOWED_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="unbowed_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15unbowed_flutter11AppDelegate")
...
SWIFT_CLASS("_TtC15unbowed_flutter17MainFlutterWindow")
